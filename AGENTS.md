...
- Use Barnacle first when the user asks where or how a feature works, names a subsystem or behavior instead of an exact file or symbol, or when concept-based discovery is more useful than exact text matching.
